...
export const metadata: Metadata = {
  ...
  description: 'Request permanent deletion of your Mezan account and associated data. Contact support@mezaninvesting.com to permanently delete your account information.',
  robots: 'index, follow',
};
            ...
            <div className="p-8 space-y-6">
              ...
              <div className="prose max-w-none">
                <p className="text-lg text-gray-700 leading-relaxed">
                  Users may request permanent deletion of their Mezan account and associated data by emailing:
                </p>
                ...
                <p className="text-gray-700">
                  <strong>Please include the email address used to register your account.</strong>
                </p>
                ...
                <div className="mt-8">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">User account information</span>
                    </li>
                    <li className="flex items-start">
                      <svg className="w-5 h-5 text-red-600 mt-0.5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">Subscription association</span>
                    </li>
                    <li className="flex items-start">
                      <svg className="w-5 h-5 text-red-600 mt-0.5 mr-3" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    ...
                    <li className="flex items-start">
                      ...
                      <span className="text-gray-700">Usage data linked to the account</span>
                    </li>
                  </ul>
                </div>
